...
//        Parameter_Init(&ONEWIRE_ROM_TEMP1, ParameterGroup_OneWire);
//        ONEWIRE_ROM_TEMP1->EditType = EDITTYPE_ONEWIREROM;
//        ONEWIRE_ROM_TEMP1->DataType = DATATYPE_ROM;
//        strcpy(ONEWIRE_ROM_TEMP1->Name, "Temperatur ONEWIRE_ROM_TEMP1");
//
//        Parameter_Init(&ONEWIRE_ROM_TEMP2, ParameterGroup_OneWire);
//        ONEWIRE_ROM_TEMP2->EditType = EDITTYPE_ONEWIREROM;
//        ONEWIRE_ROM_TEMP2->DataType = DATATYPE_ROM;
//        strcpy(ONEWIRE_ROM_TEMP2->Name, "Temperatur ONEWIRE_ROM_TEMP2");
//
//        Parameter_Init(&ONEWIRE_ROM_TEMP3, ParameterGroup_OneWire);
//        ONEWIRE_ROM_TEMP3->EditType = EDITTYPE_ONEWIREROM;
//        ONEWIRE_ROM_TEMP3->DataType = DATATYPE_ROM;
//        strcpy(ONEWIRE_ROM_TEMP3->Name, "Temperatur ONEWIRE_ROM_TEMP3");
//
//        Parameter_Init(&ONEWIRE_ROM_TEMP4, ParameterGroup_OneWire);
//        ONEWIRE_ROM_TEMP4->EditType = EDITTYPE_ONEWIREROM;
//        ONEWIRE_ROM_TEMP4->DataType = DATATYPE_ROM;
//        strcpy(ONEWIRE_ROM_TEMP4->Name, "Temperatur ONEWIRE_ROM_TEMP4");
//
//        Parameter_Init(&ONEWIRE_ROM_TEMP5, ParameterGroup_OneWire);
//        ONEWIRE_ROM_TEMP5->EditType = EDITTYPE_ONEWIREROM;
//        ONEWIRE_ROM_TEMP5->DataType = DATATYPE_ROM;
//        strcpy(ONEWIRE_ROM_TEMP5->Name, "Temperatur ONEWIRE_ROM_TEMP5");
    }

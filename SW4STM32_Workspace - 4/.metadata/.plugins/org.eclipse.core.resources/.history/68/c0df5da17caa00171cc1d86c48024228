...
void PanasonicAC_Wired_SetMode(mode_click_count){
...
void PanasonicAC_Wired_SetTempDown(TempD_click_count){
...
void PanasonicAC_Wired_SetTempUp(TempU_click_count){
...
void PanasonicAC_Wired_SetFanSpeed(FanSpeed_click_count){
...
void PanasonicAC_SetAirAuto(AirA_click_count){
	while (AirA_click_count > 0){
		EXPAND4click_set(64);
		delayUS(500000);
		EXPAND4click_set(0);
		delayUS(500000);
...
void PanasonicAC_SetAirManual(AirM_click_count){
	while (AirM_click_count > 0){

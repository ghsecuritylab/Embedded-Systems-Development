...
struct clickBoard * Board_EXPAND4_LED1;
...
int main(void)
{
    ...
    */
    ...
    Board_EXPAND4_LED1 = Create_clickBoard(6, EXPAND_ADDR_DEF, "EXP - LED1", "");
	EXPAND4click_Select(Board_EXPAND4_LED1);
	Update_Clickboard(Board_EXPAND4_LED1);

...
//--------------------------------------------------------------
#ifndef __STM32F7_UB_FATFS_H
#define __STM32F7_UB_FATFS_H
...
//--------------------------------------------------------------
// Medien freigeben/sperren
//  0 = disable
//  1 = enable
//--------------------------------------------------------------
#define   FATFS_USE_USB_MEDIA    0   // 1=USB-Stick als Medium
#define   FATFS_USE_MMC_MEDIA    1   // 1=SD-Karte als Medium
...
//--------------------------------------------------------------
typedef enum {
  USB_0 = 0,       // USB-Drive at CN13 (FS) or CN12 (HS)
  MMC_1 = 1        // MMC-Drive at CN3
}MEDIA_t;
